# Microsoft Developer Studio Project File - Name="test_dm1_threads" - Package Owner=<4>
...
!MESSAGE 
!MESSAGE NMAKE /f "test_dm1_threads.mak".
!MESSAGE 
...
# ADD LINK32 kernel32.lib user32.lib dm1_threads.lib /nologo /subsystem:console /machine:I386 /libpath:"../../lib"
...
# ADD LINK32 kernel32.lib user32.lib dm1_threads.lib /nologo /subsystem:console /debug /machine:I386 /pdbtype:sept /libpath:"../../lib"

!ENDIF 

# Begin Target

# Name "test_dm1_threads - Win32 Release"
# Name "test_dm1_threads - Win32 Debug"
