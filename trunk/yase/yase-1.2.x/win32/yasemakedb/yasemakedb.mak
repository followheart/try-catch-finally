...
CPP_PROJ=/nologo /MD /W2 /GX /Zi /Ob2 /Gf /I "../../libxml2-2.4.15/include" /I "../wget/src" /D "_DEBUG" /D "HAVE_CONFIG_H" /D "YASEMAKEDB" /D "USE_WGET" /D "USE_LIBXML" /D "WIN32" /D "_CONSOLE" /D "_MBCS" /D "USE_DL_PREFIX" /D "DEBUG" /Fp"$(INTDIR)\yasemakedb.pch" /YX /FD /GZ /c 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\yasemakedb.bsc" 
BSC32_SBRS= \
...
SOURCE=..\..\src\docweights.cpp

"$(INTDIR)\docweights.obj" : $(SOURCE) "$(INTDIR)"
	$(CPP) $(CPP_PROJ) $(SOURCE)
