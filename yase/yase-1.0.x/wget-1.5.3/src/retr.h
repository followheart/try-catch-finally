...
/* dibyendu added following for yase - 25/11/00 */
typedef int (*eval_func_t) PARAMS((void *, const char *, const char *));
extern eval_func_t Eval_func;
extern void *Eval_func_arg;
